        ...
        <div className="flex items-center gap-2">
          {engagements.length > 0 && (
            <button
              ...
              disabled={clearing}
              className="inline-flex items-center gap-1.5 h-9 px-4 bg-white text-red-600 text-sm font-medium rounded-lg border border-red-200 hover:bg-red-50 hover:border-red-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              data-testid="clear-dashboard-btn"
            >
