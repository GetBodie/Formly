...
// Check messages generated by LLM
interface Check {
  original: string
...
interface Document {
  ...
  taxYear: number | null
  issues: string[]
  checks: Check[] | null // Cached LLM-generated checks
...
export async function getChecks(
  engagementId: string,
  docId: string
): Promise<{ issues: Check[] }> {
  return fetchApi(`/api/engagements/${engagementId}/documents/${docId}/checks`)
}
...
export type { Engagement, ChecklistItem, Document, DocumentType, DocumentOverride, Check, Reconciliation, CreateEngagementData }
